...
dim Bitmap(25,136) '[Height,Width]
...
const NoiseLine = 4 'Low values make easy OCR, high values decrease readability
const MinLineLength = 3 'Minimum noise line length
