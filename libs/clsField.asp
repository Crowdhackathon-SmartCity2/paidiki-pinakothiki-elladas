...
' ------------------------------------------------------------------------------
	...
	Public Sub SaveToDisk(ByRef pstrFileName)
		...
		Set oFile = oFS.CreateTextFile(pstrFileName, True)
		
		For nIndex = 1 to LenB(ASCII2Bytes(BinaryData))
			oFile.Write Chr(AscB(MidB(ASCII2Bytes(BinaryData),nIndex,1)))
		Next
