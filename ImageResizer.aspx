...
private void Page_Load(object sender, System.EventArgs e)
{
    ...
    string strThumbFormat = ToStringDef(Request.QueryString["format"], "");
	int desiredWidth = ToIntDef(Request.QueryString["width"], -1);
	int desiredHeight = ToIntDef(Request.QueryString["height"], -1);
	int compressionLevel = ToIntDef(Request.QueryString["compression"], 0);
	
	//strImagePath = strImagePath.Replace(@"\",@"\\");
    //strThumbnailPath = strThumbnailPath.Replace(@"\", @"\\");
    ...
    switch (strThumbFormat)
    {
        ...
        // gif image
        case "gif":
            wrapper.Save(strThumbnailPath, System.Drawing.Imaging.ImageFormat.Gif, compressionLevel);
            break;
        // png image
        case "png":
            wrapper.Save(strThumbnailPath, System.Drawing.Imaging.ImageFormat.Png, compressionLevel);
            break;
        // tiff image
        case "tiff":
            wrapper.Save(strThumbnailPath, System.Drawing.Imaging.ImageFormat.Tiff, compressionLevel);
            break;
        // bmp image
        case "bmp":
            wrapper.Save(strThumbnailPath, System.Drawing.Imaging.ImageFormat.Bmp, compressionLevel);
            break;
        // defaults to jpeg
        default:
            wrapper.Save(strThumbnailPath, System.Drawing.Imaging.ImageFormat.Jpeg, compressionLevel);
...
public class BitmapWrapper
{
	...
	private Color[ , ] PixelMatrix
	{
		...
		{
			Save(filename,m_Bitmap.RawFormat, 0);
		}

		public void Save(string filename,System.Drawing.Imaging.ImageFormat fileFormat, int compressionLevel)
		{
			...
			else
			{
				...
				try
				{
					m_Bitmap.Save(filename, jgpEncoder, myEncoderParameters);
				}
				catch (Exception exp)
				{
